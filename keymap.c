...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_ortho_5x15(
    ...
    KC_LCTL, _______, _______, MEDIA,   KC_LALT, KC_LGUI, KC_SPC,  NUMPAD,  SYMBOLS, KC_RCTL, LAMBDA,  _______, _______, _______, _______
  ),
  ...
  [_NUMPAD] = LAYOUT_ortho_5x15(
    ...
    _______, _______, _______, _______, KC_DEL,  KC_BSPC, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PCMM, _______, _______,
